...
MenuOption displayMenu()
{
    ...
    sf::RenderWindow window(sf::VideoMode::getDesktopMode(), "The Great War - Menu", sf::Style::Fullscreen);
    ...
    for (int i = 0; i < optionCount; ++i)
    {
        ...
        borders[i].setSize(
            sf::Vector2f(menuOptions[i].getGlobalBounds().width + 20, menuOptions[i].getGlobalBounds().height + 20));
