...
int main()
{
	// Menu is currently not implemented so disable call for now
	/*
	...
	*/
	...
	agentManager.placePathfinderAgent(sf::Vector2i(8, 8), &scene.gameScene, PathfinderAgent(8, 8, "PathfinderAgent"),
									  gameStateManager);
	agentManager.placeMobileAgent(sf::Vector2i(8, 8), &scene.gameScene, MobileAgent(8, 8, 1, 1, 1.7f, 1, "RedBaron"),
								  gameStateManager);
